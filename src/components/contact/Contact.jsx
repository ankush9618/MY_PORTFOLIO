                ...
                <div className='md:w-8/10 w-9/10 mx-auto md:flex justify-center gap-8'>
                    ...
                    <div className='text-start w-100 '>
                        <form action="">
                            ...
                            <textarea type="text" placeholder='Enter your message here..' id="message" className='md:w-full border-2 px-2 py-1 block mt-2 mb-5 rounded-md border-gray-400' rows={5} cols={30}/>
